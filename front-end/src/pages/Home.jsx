        ...
        <div>
            ...
            <div className="w-full relative">
                ...
                <div className='absolute top-0 left-0 flex'>
                    <div className='absolute bg-bimec-heavy-green w-[20rem] h-28 mt-[36rem] ml-[12rem] rounded-lg flex justify-between items-center'>
                        <p className="ml-8 text-lg text-white font-sans">Book an Appointment</p>
                        <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="1.5" stroke="currentColor" class="size-20 text-white absolute ml-[14rem]">
                    ...
                    <div className='absolute bg-bimec-green w-[16rem] h-28 mt-[36rem] ml-[38rem] rounded-lg flex justify-between items-center'>
                        ...
                        <svg class="size-20 text-white" aria-hidden="true" xmlns="http://www.w3.org/2000/svg" width="24" height="24" fill="none" viewBox="0 0 24 24">
            ...
            <div className="mt-32 absolute flex flex-col items-center w-full">
                ...
                "At BIMEC, we are dedicated to providing compassionate, high-quality care to every patient. With a team of experienced doctors, nurses, and healthcare professionals, we focus on your health and well-being every step of the way. Whether you're seeking preventive care, specialized treatment, or emergency services, we prioritize your comfort and trust. Our commitment is to treat you like family, ensuring that your health is in the best hands possible."
                </p>
                <a className="w-[10rem] flex text-bimec-green hover:underline" href="/">
                    Learn More
                    <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="1.5" stroke="currentColor" class="size-5 ml-2 mt-0.5 text-bimec-heavy-green">
