    ...
    <div className="container mx-auto px-4">
      ...
      <div className="flex items-center justify-center min-h-[calc(100vh-100px)]">
        <div className="flex flex-col lg:flex-row items-center gap-6 lg:gap-12 w-full max-w-5xl">
          ...
          <div
            className={`hidden lg:block flex-1 w-full max-w-xs mr-auto transform transition-all duration-1000 delay-300 ${
              isVisible
          ...
          <div
            className={`flex flex-col items-center lg:items-start flex-1 w-full transform transition-all duration-1000 ${
              isVisible
                ? "translate-x-0 opacity-100"
                : "translate-x-20 opacity-0"
            }`}
          >
            <div className="w-full max-w-xl">
              <h1
                className={`font-bold text-3xl md:text-4xl mb-4 text-center lg:text-left text-gray-800 transform transition-all duration-700 delay-200 ${
                  isVisible
              ...
              <p
                className={`font-normal text-sm md:text-base mb-9 text-center lg:text-left text-gray-500 transform transition-all duration-700 delay-300 ${
                  isVisible
                    ? "translate-y-0 opacity-100"
                    : "translate-y-10 opacity-0"
                }`}
              ...
              <form className="w-full space-y-6" onSubmit={handleSubmit}>
                ...
                <div
                  className={`grid grid-cols-1 md:grid-cols-2 gap-4 transform transition-all duration-700 delay-400 ${
                    isVisible
                      ? "translate-y-0 opacity-100"
                      : "translate-y-10 opacity-0"
                  }`}
                ...
                <div
                  className={`grid grid-cols-1 md:grid-cols-2 gap-4 transform transition-all duration-700 delay-500 ${
                    isVisible
                      ? "translate-y-0 opacity-100"
                      : "translate-y-10 opacity-0"
                  }`}
                ...
                <div
                  className={`flex items-start transform transition-all duration-700 delay-800 ${
                    isVisible
                      ? "translate-y-0 opacity-100"
                      : "translate-y-10 opacity-0"
                  }`}
                >
                  ...
                  <label htmlFor="terms" className="ml-2 text-sm text-gray-700">
                    I agree to all the{" "}
                    <a
                      className="text-bimec-heavy-green hover:text-bimec-green transition-colors duration-200"
                      href="#"
                    >
                      Terms
                    </a>{" "}
                    and{" "}
                    <a
                      className="text-[#FF8682] hover:text-[#ff6b6b] transition-colors duration-200"
                      href="#"
                    >
                      Privacy Policies
                    </a>
                ...
                <p
                  className={`text-center text-sm transform transition-all duration-700 delay-[1000ms] ${
                    isVisible
                      ? "translate-y-0 opacity-100"
                      : "translate-y-10 opacity-0"
                  }`}
                >
                  ...
                  <a
                    className="text-[#FF8682] hover:text-[#ff6b6b] font-medium transition-colors duration-200"
                    href="/login"
                  >
                    Login
                  </a>
                ...
                <div
                  className={`flex items-center my-4 transform transition-all duration-700 delay-[1100ms] ${
                    isVisible
