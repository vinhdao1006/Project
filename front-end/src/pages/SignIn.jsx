...
function SignIn() {
  ...
  const handleGoogleSuccess = (credentialResponse) => {
    ...
    axios
      .post("http://localhost:3001/api/users/google-login", {
        token: credential,
      })
      .then((response) => {
    ...
    <div className="container mx-auto px-4">
      ...
      <div className="flex items-center justify-center min-h-[calc(100vh-120px)]">
        <div className="flex flex-col lg:flex-row items-center gap-6 lg:gap-12 w-full max-w-3xl">
          ...
          >
            <div className="w-full max-w-md">
              ...
              <form className="w-full space-y-5" onSubmit={handleSubmit}>
                ...
                <div
                  className={`flex items-center justify-between transform transition-all duration-700 delay-600 ${
                    isVisible
                      ? "translate-y-0 opacity-100"
                      : "translate-y-10 opacity-0"
                  }`}
                >
                  ...
                  <a
                    className="text-sm text-[#FF8682] hover:text-[#ff6b6b] transition-colors duration-200"
                    href="#"
                  >
                    Forgot password?
                  </a>
                ...
                <div
                  className={`transform transition-all duration-700 delay-[700ms] ${
                    isVisible
                      ? "translate-y-0 opacity-100"
                      : "translate-y-10 opacity-0"
                  }`}
                ...
                {/* Sign up Link */}
                <p
                  className={`text-center text-sm transform transition-all duration-700 delay-[800ms] ${
                    isVisible
                      ? "translate-y-0 opacity-100"
                      : "translate-y-10 opacity-0"
                  }`}
                ...
                <div
                  className={`flex items-center my-4 transform transition-all duration-700 delay-[900ms] ${
                    isVisible
                ...
                {/* Google Button*/}
                <div
                  className={`w-full flex items-center justify-center transform transition-all duration-700 delay-[1000ms] ${
                    isVisible
                      ? "translate-y-0 opacity-100"
                      : "translate-y-10 opacity-0"
                  }`}
          ...
          <div
            className={`hidden lg:block flex-1 w-full max-w-sm ml-auto transform transition-all duration-1000 delay-300 ${
              isVisible
                ? "translate-x-0 opacity-100"
                : "translate-x-20 opacity-0"
            }`}
