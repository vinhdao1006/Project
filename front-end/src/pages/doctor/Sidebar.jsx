...
function Sidebar() {
  ...
  return (
    <aside 
      className="w-64 bg-white border-r border-bimec-gray/20 flex flex-col h-screen overflow-hidden shadow-sm"
    ...
    >
      ...
      <div 
        ...
        style={{ 
          background: `linear-gradient(to right, rgba(244, 255, 243, 0.1), rgba(244, 255, 243, ${isHovered ? 0.4 : 0.1}))`,
      ...
      >
        ...
        >
          ...
          <span className="text-2xl font-bold text-bimec-heavy-green tracking-tight">
            <span className="inline-block transform transition-transform duration-300 group-hover:translate-y-0">B</span>
            <span className="inline-block transform transition-transform duration-300 delay-75 group-hover:translate-y-0">I</span>
            <span className="inline-block transform transition-transform duration-300 delay-100 group-hover:translate-y-0">M</span>
            <span className="inline-block transform transition-transform duration-300 delay-150 group-hover:translate-y-0">E</span>
            <span className="inline-block transform transition-transform duration-300 delay-200 group-hover:translate-y-0">C</span>
          </span>
        </div>
          ...
          return (
            <NavLink
              ...
              style={{
                ...
                transition: `transform 0.3s ease-out ${index * 0.05}s, opacity 0.3s ease-out ${index * 0.05}s, background-color 0.3s, color 0.3s, box-shadow 0.3s`
              }}
            >
