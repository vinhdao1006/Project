...
// Updated patient data to match doctor/patients structure
const patientsData = [
  {
    patient: "John Doe",
  ...
  },
  {
    ...
    dateOfBirth: "10 Aug, 1991",
    gender: "Female",
    lastVisit: "20 Apr, 2023",
    avatar: "JL"
  },
];
            ...
            >
              ...
              <td className="py-4 px-6">
                <div className="flex items-center gap-2 text-gray-500">
                  <Calendar className="w-4 h-4 text-bimec-green" />
                  {patient.lastVisit}
                </div>
              </td>
            </tr>
...
const PatientsManagement = () => {
  ...
  const handlePatientClick = (patient) => {
    ...
    // Navigate to patient details page in production code
  };
