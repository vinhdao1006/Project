        ...
        <div className="text-center max-w-md px-6 py-8 bg-white rounded-lg shadow-sm">
          <div className="w-16 h-16 bg-red-50 rounded-full flex items-center justify-center mx-auto mb-4">
            <svg
              ...
              className="h-8 w-8 text-bimec-red"
              fill="none"
              viewBox="0 0 24 24"
              stroke="currentColor"
            >
    ...
    <div className="overflow-x-hidden overflow-y-auto min-h-screen bg-white">
      ...
      <div className="bg-gradient-to-r from-bimec-green to-bimec-heavy-green py-12 md:py-16">
        <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8">
          <h1
            className={`text-3xl md:text-4xl font-light text-white text-center transform transition-all duration-1000 ${
              isVisible
          ...
          <p
            className={`text-white/80 text-center mt-2 transform transition-all duration-1000 delay-200 ${
              isVisible
                ? "translate-y-0 opacity-100"
                : "translate-y-10 opacity-0"
            }`}
      ...
      <div className="max-w-4xl mx-auto px-4 py-8 animate-slideInUp animation-delay-300 lg:-mt-4 md:-mt-8">
        <div className="bg-white rounded-xl shadow-sm border border-gray-100 overflow-hidden">
          {appointments.length === 0 ? (
            <div
              className={`text-center py-16 px-4 transform transition-all duration-1000 delay-400 ${
                isVisible
                  ? "translate-y-0 opacity-100"
            ...
            >
              ...
              <p className="mb-6 text-gray-600 max-w-md mx-auto">
                You have not booked any appointments. Schedule your first
                appointment to start your healthcare journey.
              </p>
              <button
            ...
            <div
              className={`p-6 transform transition-all duration-1000 delay-400 ${
                isVisible
                  ? "translate-y-0 opacity-100"
                  : "translate-y-20 opacity-0"
              }`}
        ...
        {appointments.length > 0 && (
          <div
            className={`mt-8 bg-white rounded-xl shadow-sm border border-gray-100 overflow-hidden transform transition-all duration-1000 delay-750 ${
              isVisible
                ? "translate-y-0 opacity-100"
                : "translate-y-20 opacity-0"
            }`}
          >
            ...
            >
              <h2 className="text-lg font-medium text-bimec-black">
                Past Appointments
              </h2>
              <ChevronDownIcon
                className={`h-5 w-5 text-bimec-green transition-transform duration-150 ${
      ...
      <div
        className={`mt-16 mx-auto w-full transform transition-all duration-1000 delay-900 ${
      ...
      <div
        className={`mt-8 mx-auto w-full transform transition-all duration-1000 delay-1000 ${
          isVisible ? "translate-y-0 opacity-100" : "translate-y-20 opacity-0"
        }`}
      >
        <Footer />
